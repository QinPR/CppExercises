/*
    ...
    Print out the biggest number and second biggest number in list.
*/
...
void find_biggest_game() {
    ...
    */
    ...
    cout << "The second largest value was " << second_biggest_num << endl;
